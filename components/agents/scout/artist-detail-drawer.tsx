      ...
      <SheetContent className="w-full sm:max-w-xl overflow-y-auto bg-background/95 backdrop-blur-xl border-l border-border/50">
        <SheetHeader className="space-y-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <SheetDescription className="text-base">{artist.track}</SheetDescription>
            </div>
          </div>
        ...
        <div className="mt-6 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="font-medium">{artist.engagement}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-xl font-semibold flex items-center gap-1 text-cosmic-teal">
