...
export default function FanAgentPage() {
  ...
  useEffect(() => {
    if (openDrawer && selectedItem?.platform === "Instagram") {
                  ...
                  <div className="relative rounded-lg overflow-hidden border border-border/50 bg-gradient-to-br from-pink-500/5 via-purple-500/5 to-orange-500/5">
                    ...
                    <div className="p-4">
                      <blockquote 
                        ...
                        data-instgrm-permalink="https://www.instagram.com/algoryxmusic/?utm_source=ig_embed&utm_campaign=loading" 
                      ...
                      >
                        <div style={{ padding: '16px' }}>
                          <a 
                            href="https://www.instagram.com/algoryxmusic/?utm_source=ig_embed&utm_campaign=loading" 
                            style={{
                              background: '#FFFFFF',
                              lineHeight: '0',
                              padding: '0 0',
