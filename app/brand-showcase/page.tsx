  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto">
        {/* Header */}
        <div className="text-center space-y-4 p-8 pb-0 max-w-7xl mx-auto">
        ...
        {/* Unified Figma Layer Explorer - Full Width */}
        <section className="space-y-6 p-8">
          <div className="max-w-7xl mx-auto">
            <GradientText className="text-3xl font-medium">Figma Design System</GradientText>
            <p className="text-muted-foreground mb-6">
              Explore Figma designs, generate React components, and integrate them into your app
            </p>
          </div>
